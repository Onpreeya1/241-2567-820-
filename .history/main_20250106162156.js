...
let result = number1 >= number2 // boolean ค่าที่ได้จะเป็น ture false 
...
console.log('name_list is',name_list.length);console.log('name_list is',name_list.length);
